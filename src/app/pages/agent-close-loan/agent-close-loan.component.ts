...
@Component({
  selector: 'app-agent-close-loan',
  templateUrl: './agent-close-loan.component.html',
  styleUrls: ['./agent-close-loan.component.css']
})
export class AgentCloseLoanComponent implements OnInit {
